...
commands.build:     bash .project/verify-linux.sh cargo build --release -p highper-gateway
commands.test:      bash .project/verify-linux.sh cargo test --workspace --lib -- --test-threads=4
commands.lint:      bash .project/verify-linux.sh cargo clippy --workspace --all-features -- -D warnings
commands.typecheck: bash .project/verify-linux.sh cargo check --workspace --all-features
...
tier.rule: highper-gateway/src/tls/** T3
tier.rule: highper-gateway/src/gateway/auth/** T3
tier.rule: highper-gateway/src/admin/** T3
tier.rule: highper-gateway/src/middleware/waf/** T3
tier.rule: highper-gateway/src/gateway/ratelimit/** T2
tier.rule: highper-gateway/src/middleware/rate_limit.rs T2
tier.rule: highper-gateway/src/middleware/ddos_protection.rs T2
tier.rule: highper-gateway/src/proxy/** T2
tier.rule: highper-gateway/src/http/** T2
tier.rule: highper-gateway/src/runtime/** T2
tier.rule: highper-gateway/src/runtime_config/** T2
tier.rule: .github/workflows/** T2
